...
public class ExceptionsHandler {
    ...
    public ErrorsDTO handleServerError(Exception ex) {
        ex.printStackTrace();
        return new ErrorsDTO("C'è stato un errore! Lo risolveremo al più presto!", LocalDateTime.now());
    }
    @ExceptionHandler(UnauthorizedAnnuncioAccessException.class)
    @ResponseStatus(HttpStatus.FORBIDDEN)
    public ErrorsDTO handleUnauthorizedAccess(UnauthorizedAnnuncioAccessException ex) {
